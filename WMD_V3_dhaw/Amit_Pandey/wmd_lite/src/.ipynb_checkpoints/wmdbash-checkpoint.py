 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "    prediction_dictionary[i] = [Test_BBCsport_label[i],arr1indx[:30],Train_BBCsport_label[arr1indx[::1]][:30],distance_fromTrainset[arr1indx[::1]][:30],np.array([predicted_cat_k5,predicted_cat_k7, predicted_cat_k11,predicted_cat_k15,predicted_cat_k21])]\n",
    "    \n",
    ...
    "\n",
    "with Pool(36) as p :\n",
    "        predicted_Categorieslist = p.map(predict_Category,[0,1,2,3])\n",
    "        \n",
    ...
    "json.dump(prediction_dictionary, a_file)\n",
    "a_file.close()\n",
    "\n",
